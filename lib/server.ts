...
export function newSessionId() {
  ...
  // A cryptographically random session remains valid even before the optional
  // Web signing secret/backend token is configured. Once the token exists,
  // sessions become HMAC-signed automatically.
...
export function isSignedSessionId(value: string | null | undefined) {
  ...
  // Unsigned fallback: 128 bits of entropy and strict hexadecimal format.
